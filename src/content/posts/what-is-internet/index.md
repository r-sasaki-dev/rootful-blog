...
- [インターネットって何？](#インターネットとは)

- [インターネットの仕組みが全然わからない...](#インターネットの構造)

- [インターネットについて勉強したいんだけど何から始めたら良いかわからない...](#まとめ)
...
1. [LAN](#lanlocal-area-network)

3. [WAN](#wanwide-area-network)

5. [ISP](#ispinternet-service-provider)
